  ...
  return (
    ...
    from-gray-800 to-black text-white">
      <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full '>
        ...
        My name is Akash Vaishnav, currently pursuing my B.Tech from KNIT Sultanpur. I am passionate about web development and C++. With a strong skill set in React.js, HTML, CSS (Tailwind), JavaScript, SQL, and MongoDB, C++, data structures and algorithms .
